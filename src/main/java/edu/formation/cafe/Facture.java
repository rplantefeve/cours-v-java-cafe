...
public class Facture {
  ...
  public Facture(int numero, Date date) {
    ...
    this.date = date;
    /*
     * initialisation notre liste d'enregistrement (rappel : un enre- gistrement contient une conso
  ...
  /**
   * Implémente l'action du serveur à sortir son carnet de factures lorsqu'il arrive à la table
   * 
   * @param serveur Le serveur en question
   * @param table La table servie
   */
   ...
   * 
   * @param conso La consommation désirée
  ...
  public String toString() {
    ...
    StringBuffer sb =
        new StringBuffer(String.format("| %1$-3s| %2$-21s| %3$-6s|%4$22s|%4$8s|%4$7s|%n",
            this.numero, this.serveur.getNom(), this.table.getNumero(), ""));
